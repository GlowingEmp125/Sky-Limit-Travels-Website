              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Discount upto (%)</TableHead>
                ...
                <TableBody>
                  {holidays.map((holiday) => (
                    <TableRow key={holiday.id}>
                      ...
                      <TableCell>
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${holiday.available
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Link href={`/destinations/${holiday.id}`}>
                            <Button variant="ghost" size="icon">
                              <Eye className="w-4 h-4" />
                            </Button>
                          </Link>
                          <Link href={`/admin/destinations/${holiday.id}/edit`}>
                            <Button variant="ghost" size="icon">
